---
name: find-skills
description: Find reusable skills from the vercel-labs/skills registry (especially by task keywords), evaluate fit, and suggest how to install/adapt them for RayClaw.
...
5. If none fit exactly, propose adaptation steps for RayClaw.
...
2. Why it fits
3. Requirements
4. Install/adapt steps for RayClaw
5. Alternative options

## RayClaw adaptation hints
...
- If upstream skill assumes another runtime, add a short "RayClaw notes" section describing equivalent commands.
