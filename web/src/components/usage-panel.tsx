              ...
              {usageMemory ? (
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 gap-3 xl:grid-cols-2">
                    <TrendRow title="Reflector Inserts (24h)" subtitle="hourly buckets" values={trend24h.inserted} color="#4aea7a" />
                    <TrendRow title="Reflector Updates (24h)" subtitle="hourly buckets" values={trend24h.updated} color="#5ba8f5" />
                  ...
                  <div className="grid grid-cols-1 gap-3 xl:grid-cols-2">
                    <TrendRow title="Reflector Inserts (7d)" subtitle="daily buckets" values={trend7d.inserted} color="#4aea7a" />
                    <TrendRow title="Reflector Updates (7d)" subtitle="daily buckets" values={trend7d.updated} color="#5ba8f5" />
