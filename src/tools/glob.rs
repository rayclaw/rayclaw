...
mod tests {
    ...
    async fn test_glob_finds_files() {
        let dir = std::env::temp_dir().join(format!("rayclaw_glob_{}", uuid::Uuid::new_v4()));
    ...
    async fn test_glob_no_matches() {
        let dir = std::env::temp_dir().join(format!("rayclaw_glob2_{}", uuid::Uuid::new_v4()));
        std::fs::create_dir_all(&dir).unwrap();
    ...
    async fn test_glob_defaults_to_working_dir() {
        let root = std::env::temp_dir().join(format!("rayclaw_glob3_{}", uuid::Uuid::new_v4()));
